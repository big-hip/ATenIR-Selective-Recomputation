...
| F8 | 横向方法平均 MRE 对比 | ex_horizontal_comparison.csv |
| F9 | L2 → fusion-only → safe-reuse → L3 消融 | ex_horizontal_comparison.csv |

### 测试: pytest 回归测试覆盖 capture / simulation / fusion / profiler 等模块
